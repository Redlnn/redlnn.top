      ...
      <el-row>
        ...
        <el-col :xs="24" :sm="20" :lg="16" :xl="12">
          ...
          <el-alert
            title="前排提示"
            type="info"
            description="这个页面是中二病发作写的，非求偶现场，哦不对我脱单了，那没事了（doge）。这个页面看起来性格跟平时不一样，请以平时为准。"
            show-icon
            effect="dark"
            :closable="closable"
          ></el-alert>
          ...
          <p>1.5. 挺废的，什么都不会。别看这个网站是<code>vue.js</code>，其实根本不会</p>
          <p>1.6. 老社恐，现实中瑟瑟发抖，没几个朋友，不过也很感谢一直陪我的人</p>
          <p>1.7. 不容易生气，但生起气来会坏（<span title="你知道的太多了" class="curtain">纠正：气急败坏</span>）</p>
          <h2>喜欢的东西</h2>
          <h3>吃的喝的</h3>
          <p>2.1.1. 我永远喜欢可口可乐！<del>百事也不是不行</del></p>
          <p>2.1.2. 我永远喜欢炸鸡汉堡！</p>
          <h3>番剧</h3>
          <p>2.2.1. 二次元浓度低，AGCN 里面也就对游戏敢兴趣（但其实也玩得不多，<span title="你知道的太多了" class="curtain">所以我的青春都干嘛去了啊喂(#`O′)</span>）</p>
          <p>2.2.1. 不怎么看番，也不怎么看漫画</p>
          ...
          <h3>书、音乐或电影</h3>
          <p>2.4.1. 书的话，《三体》、《海底两万里》、《神秘岛》、《鲁滨逊漂流记》，还有小时候喜欢的皮皮鲁和舒克贝塔系列</p>
          <p>2.4.2. 电影的话，《流浪地球》、《星际穿越》、《火星救援》之类的</p>
          <p>2.4.3. 音乐这方面，什么类型都能听，没有特别喜欢的</p>
          <h3>动漫或影视角色？游戏角色？</h3>
          <p>2.5.1. 动漫角色的话，小樱、李小狼（<del>王小明</del>），还有就想不出来了</p>
          <p>2.5.2. 游戏角色的话，原神里少年和少女模型的都喜欢！万叶，嘿嘿嘿~ 空宝，嘿嘿嘿~</p>
          <h3>电子产品</h3>
          <p>2.6.1. 一加你被骂得好惨啊</p>
          <p>2.6.2. 电脑（配件和整机都喜欢）、手机、平板</p>
          <p>2.6.3. 曾经在耳机圈边缘徘徊过，发现太费钱了就算了</p>
          <h2>会些什么</h2>
          <p>3.1. 画画？不会。唱歌？不会。写作？不会。写代码？<code>print('Hello World')</code>这样的可以不？真的也就只会 Hello World 了</p>
          <p>3.2. 只学了一学期的<code>C</code>和<code>Pyhton</code>。<code>C</code>基本忘得差不多了，<code>Python</code>也就偶尔用用，还没有深入学习过。<code>HTML</code>和<code>JavaScript</code>从来没学过，不过<code>HTML</code>处在能在搜索引擎的帮助下理解，<code>JavaScript</code>看都看不懂</p>
          <p>3.3. 什么？不会<code>js</code>那这个网站怎么做的？看着文档，在搜索引擎的帮助下东拼西凑出来的啊~还请各位大佬轻喷</p>
          <h2>玩些什么</h2>
          <p>4.1. 目前主要玩《原神（Genshin Impact）》，偶尔也玩玩《我的世界（Minecraft）》，再多的就不玩了（<span title="你知道的太多了" class="curtain">主要还是玩不懂，而且肝不够</span>）</p>
          <p>4.2. 对其他游戏无感，不是米哈游无脑吹，本人不攻击其他游戏及其玩家</p>
          <p>4.3. 你说原神抄袭？对，他抄了世界上所有游戏，<del>米哈游该死</del></p>
          <h2>哪里能找到</h2>
